const linksTenantHelp = [
  ...
  {
    number: 2,
    title: 'Falar com a Alugar Imóveis',
    id: '0002',
  },
  {
    number: 3,
...
const topics = [
  {
    ...
    title: 'Como Alugar?',
    subTitle: `
      <p>Para começar devo dizer que Alugar com a gente é rápido e fácil.</p>
      <p>Preparei um material com tudo o que você precisa saber para alugar o seu imóvel.</p>`,
    links: [
      {
        titleLink: 'Processo de locação RÁPIDO e FÁCIL em 5 etapas.',
        route: '3001',
      },
    ],
  },
  {
    ...
    title: 'Falar com a Alugar Imóveis',
    subTitle: `
      <p>Eu já te disse que Alugar com a gente é rápido e fácil? E falar com a gente é ainda mais fácil.</p>
      <p>Somos uma imobiliária 100% digital o que quer dizer que a gente se encontra online, em vários canais, dá uma olhadinha aqui:</p>`,
    links: [
      {
        titleLink: 'Quais são os canais de atendimento da Alugar Imóveis?',
        route: '3002',
      },
    ],
  },
  {
    ...
    title: 'Área do Cliente e Aplicativo',
    subTitle: `
      <p>Seja bem-vindo a mais um canal de comunicação da Alugar Imóveis com você.</p>
      <br/>
      <p>A Área do Cliente e o aplicativo Alugar Imóveis são espaços de autoatendimento desenvolvidos pensando em disponibilizar, de forma prática e segura, as principais ferramentas de gestão do seu contrato de locação. Tudo isso na palma da sua mão.</p>
      <br/>
      <p>No conteúdo abaixo você vai encontrar o passo a passo para usar nossos canais de serviço online.</p>
      <br/>
      <p><a href="">Alugar Imóveis, a sua imobiliária digital!</a></p>`,
    links: [
      {
  ...
  },
  {
    id: '0004',
    title: 'Contas de Consumo',
    subTitle: `<p>Organizei esse material com todas as informações sobre as contas de consumo previstas no seu contrato de locação.</p>
      <br/>
      <p>Aqui tem uma relação das principais taxas e despesas previstas:</p>`,
    links: [
      {
        titleLink: 'IPTU',
        subLinks: [
          {
            titleLink: 'O que é o IPTU?',
            route: '',
          },
          {
            titleLink: 'Quem deve pagar o IPTU?',
            route: '',
          },
          {
            titleLink: 'Como é cobrado o IPTU?',
            route: '',
          },
          {
            titleLink:
      ...
      },
      {
        ...
        subLinks: [
          ...
          {
            titleLink: 'Como ter acesso a segunda via da conta de energia?',
            route: '',
          },
          {
            titleLink:
      ...
      },
      {
        ...
        subLinks: [
          ...
          {
            titleLink: 'Como ter acesso a segunda via da conta de água?',
            route: '',
          },
        ],
      },
      {
        ...
        subLinks: [
          {
            titleLink: 'O que preciso saber sobre a taxa de lixo?',
            route: '',
          },
        ],
      },
      {
        ...
        subLinks: [
          {
            titleLink: 'O que preciso saber sobre o seguro incêndio?',
            route: '',
          },
          {
            titleLink: 'Como funciona o seguro incêndio da Alugar Imóveis?',
            route: '',
          },
        ],
      },
      {
        ...
        subLinks: [
          ...
          {
            titleLink: 'O que é o Fundo de Reserva?',
            route: '',
          },
        ],
      },
  ...
  },
  {
    id: '0005',
    title: 'Pagamentos',
    subTitle: `<p>Preparei um material com todas as orientações que você precisa saber sobre pagamentos do contrato de locação.</p>`,
    links: [
      {
  ...
  },
  {
    id: '0006',
    title: 'Manutenção e Reparos',
    subTitle: `<p>Aqui você encontra informações importantes sobre manutenção e reparos que podem ser necessários no imóvel. Tenho certeza que depois que conferir as orientações dessa página, será mais simples realizar a manutenção do imóvel.</p>`,
    links: [
      {
      ...
      {
        titleLink: 'Responsabilidade do Locatário (inquilino).',
        route: '3022',
      },
      {
        titleLink: 'Responsabilidade do Locador (proprietário)',
        route: '3022',
      },
      {
      ...
      {
        titleLink: 'Como abrir um Ticket',
        route: '3024',
      },
      {
  ...
  },
  {
    id: '0007',
    title: 'Rescisão',
    subTitle: `<p>Veja o material que preparei um material com todas as orientações que você precisa para entender o processo de rescisão do contrato de locação do imóvel.</p>`,
    links: [
      {
        titleLink: 'Guia completo para rescisão do contrato de locação.',
        route: '',
      },
      {
        titleLink: 'Aviso de desocupação.',
        subLinks: [
          {
      ...
      {
        titleLink: 'Agendamento da vistoria final e rescisão de contrato.',
        subLinks: [
          {
          ...
          {
            titleLink: 'Como agendar o atendimento da rescisão?',
            route: '3002',
          },
        ],
      },
      {
        titleLink: 'Vistoria final.',
        subLinks: [
          {
            titleLink: 'Como funciona a vistoria final da Alugar Imóveis?',
            route: '',
          },
          {
            titleLink:
          ...
          {
            titleLink: 'O que acontece após a vistoria final do imóvel?',
            route: '',
          },
        ],
      },
      {
        titleLink: 'Reparos no imóvel.',
        subLinks: [
          {
            titleLink:
              'Como é feita a cobrança do aluguel durante o período de reparos no imóvel?',
      ...
      {
        titleLink: 'Rescisão do contrato de locação.',
        subLinks: [
          {
            titleLink:
              'Quando o locatário (inquilino) pode rescindir o contrato de locação?',
  ...
  },
  {
    id: '0009',
    title: 'Anúncio de imóveis',
    subTitle: `<p>Para começar devo dizer que ser cliente da Alugar Imóveis é a certeza de realizar excelentes negócios com aluguel 100% garantido.</p>
      <p>Somos uma imobiliária digital com um perfil inovador para criar a melhor experiência aos nossos parceiros e clientes. Desenvolvemos processos modernos altamente eficientes e oferecemos benefícios exclusivos.</p>
      <p>Vem anunciar com a gente! Só na Alugar Imóveis você tem garantia e antecipação de aluguel.</p>
      <p>Confira aqui as etapas do nosso processo:</p>`,
    links: [
      {
        titleLink: 'Quero anunciar meu imóvel para locação, o que devo fazer?',
        route: '',
      },
      {
        titleLink:
          'Quais as vantagens de ter meu imóvel administrado pela Alugar Imóveis?',
        route: '',
      },
      {
        titleLink: 'Como eu sei se meu imóvel recebeu visita?',
        route: '',
      },
      {
        titleLink: 'Como eu sei se meu imóvel está sendo alugado?',
        route: '',
      },
      {
        titleLink: 'Quanto custa para anunciar meu imóvel pela Alugar Imóveis?',
        route: '',
      },
      {
        titleLink:
          'Quais serviços são realizados pela Alugar Imóveis para gerenciar o meu imóvel?',
        route: '',
      },
      {
        titleLink: 'Quando meu imóvel for alugado quais taxas serão cobradas?',
        route: '',
      },
      {
        titleLink:
          'Quero retirar meu imóvel da base da Alugar Imóveis, o que devo fazer?',
        route: '',
      },
      {
        titleLink: 'Seu imóvel foi alugado!',
        route: '',
      },
      {
        titleLink:
          'Como funciona a assinatura do meu contrato com a Alugar Imóveis?',
        route: '',
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        titleLink: 'O que eu recebo?',
        route: '',
      },
      {
        titleLink: 'Como acessar extrato de pagamento?',
        route: '',
      },
      {
        titleLink: 'Como acessar o informe de rendimento?',
        route: '',
      },
    ],
  },
  ...
  },
  {
    id: '0012',
    title: 'Indicação de imóveis',
    subTitle: `<p>Preparei um material com todas as orientações que você precisa saber sobre Indicação de Imóveis! Veja abaixo:</p>`,
    links: [
      {
  ...
  },
  {
    id: '0013',
    title: 'Antecipação de aluguel',
    subTitle: `<p>Preparei um material com todas as orientações que você precisa saber sobre a antecipação de aluguel. Confira!</p>`,
    links: [
      {
      ...
      {
        titleLink: 'Como solicito a antecipação de aluguel?',
        route: '',
      },
    ],
  },
...
const content = [
  ...
  },
  {
    ...
    content:
      '<p>Primeiro, é preciso formalizar a sua intenção em desocupar o imóvel com 30 dias de antecedência. Você deve fazer isso através de um documento chamado Aviso de Desocupação.</p><br/><p>Clique aqui para saber mais sobre o <a href="https://centraldeajudarotina.com.br/home/topics/0006/content/3027">Aviso de Desocupação</a>.</p><br/><p>Realizar o reparo do imóvel para que seja entregue nas mesmas condições do início da locação, conforme o laudo da vistoria inicial. Lembrando que caso o imóvel tenha sido entregue com pintura nova, o mesmo deverá ser devolvido também com a pintura nova.<p><br/><img src="/assets/3026-1.jpg"</p></p><br/><p>Durante os 30 dias que antecedem a desocupação do imóvel, você deve agendar a vistoria final e a entrega das chaves.</p><br/><p>Clique nos links para saber mais sobre o <a href="https://centraldeajudarotina.com.br/home/topics/0006/content/3039">Agendamento da Vistoria Final</a> e <a href="https://centraldeajudarotina.com.br/home/topics/0006/content/3030">Entrega das Chaves</a>.</p><br/><p>A vistoria final do imóvel será realizada no dia e horário agendado por você. O imóvel deverá estar completamente desocupado, limpo e com a água e energia ligados.</p><br/><p>Você receberá por e-mail o laudo da vistoria e um orçamento, caso ainda existam reparos necessários no imóvel, em até 48 horas úteis após a visita da equipe de vistoria.</p><br/><p>Caso o imóvel ainda necessite de reparos, você pode optar fazer os reparos por conta própria ou através do prestador de serviço indicado pela Rotina Imobiliária, com base no orçamento enviado no seu e-mail.</p><br/><p><a href="https://centraldeajudarotina.com.br/home/topics/0005/content/3025">Clique aqui</a> para saber mais sobre reparos no imóvel.</p><br/><p>Se não houver necessidade de reparos, você deverá comparecer na Rotina Imobiliária no dia e horário agendados para fazer a entrega das chaves e o acerto final.</p><br/><p class="P-Tina"><img src="/assets/Tina.png" class="Tina"><strong>Dica da Tina:</strong> Todo este processo pode acontecer dentro do período de 30 dias do aviso de desocupação assim você evita pagar diárias de aluguel após o vencimento do aviso.</p><br/><p><a href="https://centraldeajudarotina.com.br/home/topics/0006/content/3027">Clique aqui</a> para saber mais sobre o Aviso de Desocupação.</p>',
  },
  {
    id: '3027',
    title: 'O que é aviso de desocupação?',
    content:
      '<p>O aviso de desocupação é o documento que formaliza a intenção do cliente de desocupar o imóvel. A comunicação deve ser feita com 30 dias de antecedência da data pretendida.<p><br/><img src="/assets/3027-1.jpg"</p></p><br/><p>Durante este período será cobrado o aluguel integral independente do imóvel estar ocupado ou não.</p><br/><p>Caso o processo de rescisão ultrapasse os 30 dias serão cobradas diárias de aluguel até a efetiva entrega das chaves.</p><br/><p class="P-Tina"><img src="/assets/Tina.png" class="Tina"><strong>Dica da Tina:</strong> O processo completo para a rescisão deverá seguir os 6 passos. <a href="https://centraldeajudarotina.com.br/home/topics/0006/content/3026">Clique aqui</a> para saber o Passo a Passo para a Rescisão do Contrato de Locação.</p>',
  },
  {
    id: '3028',
    title: 'Como enviar o aviso de desocupação?',
    content:
      '<p>O aviso de desocupação deve ser formalizado por escrito e enviado para o e-mail site@rotina.com.br. O locatário (inquilino) deve utilizar o modelo de formulário padrão do aviso de desocupação <p><br/><img src="/assets/3028-1.jpg"</p></p><br/><p>É importante lembrar que o prazo de 30 dias do aviso de desocupação começará a contar a partir do envio por e-mail do documento assinado pelo locatário (inquilino).</p><br/><p class="P-Tina"><img src="/assets/Tina.png" class="Tina"><strong>Dica da Tina:</strong> O processo completo para a rescisão deverá seguir os 6 passos. <a href="https://centraldeajudarotina.com.br/home/topics/0006/content/3026">Clique aqui</a> para saber o passo a passo para a Rescisão do Contrato de Locação.</p>',
  },
  {
    id: '3029',
    title:
  ...
  },
  {
    ...
    title:
      'O que acontece se alguma fatura de contas de consumo ficar pendente após a finalização do contrato de locação?',
    content:
      '<p>Se houver contas de consumo de responsabilidade do locatário (inquilino) emitidas após a rescisão, elas serão cobradas posteriormente.<p><br/><img src="/assets/3038-1.jpg"</p></p><br/><p class="P-Tina"><img src="/assets/Tina.png" class="Tina"><strong>Dica da Tina:</strong> Para facilitar, separei algumas formas de contato das empresas para você.</p><br/><p>Energia - Cemig</p><br/><p>Online: Segunda via Cemig</p><br/><p>WhatsApp: (31) 3506-1160</p><br/><p>Central de Relacionamento com Clientes: 116</p><br/><p>Agências físicas: Pontos de atendimento Cemig</p>',
  },
  {
    id: '3039',
  ...
  },
  {
    ...
    title:
      'O locatário (inquilino) pode ser representado por terceiros no momento da vistoria final?',
    content:
      '<p>Sim, o locatário (inquilino) poderá ser representado por terceiros, tendo ciência de  que só poderá contestar o conteúdo da vistoria final comprovando as divergências identificadas.</p><p><br/><img src="/assets/3041-1.jpg"</p>',
  },
  {
    id: '3042',
    title:
      'O que acontece se o locatário (inquilino) não comparecer na vistoria final?',
    content:
      '<p>Caso o locatário (inquilino) não compareça no dia e horário marcados para a vistoria e não realize a remarcação com antecedência mínima de 01 hora, será cobrada uma taxa de visita no valor de 10%  sobre o valor do salário mínimo.</p><p><br/><img src="/assets/3042-1.jpg"</p>',
  },
  {
    id: '3043',
    title:
      'O que acontece se o imóvel não estiver desocupado no momento da vistoria?',
    content:
      '<p>A vistoria deverá ser reagendada de acordo com disponibilidade de equipe responsável, ficando o locatário (inquilino) ciente da possibilidade de cobrança de diárias adicionais de aluguel caso o prazo do aviso não seja cumprido.</p><p><br/><img src="/assets/3043-1.jpg"</p>',
  },
  {
    id: '3044',
    title: 'Como realizo meu primeiro acesso?',
  ...
  },
  {
    ...
    content:
      '<p>Sim, você pode acompanhar nossas novidades e atividades através das redes sociais clicando aqui: <a href="https://www.facebook.com/rotinaimobiliaria/">Facebook</a>, <a href="">Twitter</a>, <a href="https://www.instagram.com/rotinaimobiliaria/">Instagram</a> e <a href="">Tik Tok</a><p><br/><img src="/assets/3053-1.jpg"></p></p><br/><p>Também temos um blog bem completo que reúne artigos sobre o setor imobiliário <a href="https://rotinaimobiliaria.blogspot.com/">(confira aqui)</a>.</p><br/><p>Para assistir aos nossos vídeos, siga-nos no <a href="https://www.youtube.com/user/rotinaimobiliaria">Youtube</a>.</p><br/><p>É jornalista e quer falar com a nossa área de comunicação? Então envie e-mail para marketing@rotina.com.br </p>',
  },
  {
    id: '3054',
    title: 'Quais são e onde ficam as sedes da Rotina?',
    content:
      '<p>A Rotina Imobiliária tem atendimento presencial. Você pode escolher ir até uma de nossas unidades para falar com um de nossos especialistas:</p><br/><p>Unidade 01: Av. Afonso Pena, 1535, Bairro Nossa Senhora Aparecida, Uberlândia – Mg.</p><br/><p>Unidade 02: Av. Belarmino Cotta Pacheco, 621, Bairro Santa Mônica, Uberlândia – Mg.</p>',
  },
  {
    id: '3055',
  ...
  },
  {
    ...
    title:
      'É necessário alienar meu imóvel para realização a antecipação de aluguel?',
    content:
      '<p>Não. Hoje o processo de antecipação de aluguel é bem simples, o processo é sem burocracias, com análise e desembolso em até 72 horas. Afirmando que, não é feita restrição cadastral, nem alienação de imóvel, além de tudo, não é necessário comprovar renda.</p>',
  },
];

export const htmlFromCMS = `
  <div>Hi, 
    <SpecialButton color="red">My Button</SpecialButton>
  </div>
`;

export { linksTenantHelp, landlordHelp, about, topics, content, questions };
